...
public:
    ...
    AckFinder(const std::string& client_ip, const std::string& server_ip, uint16_t client_port, uint16_t server_port,
        const std::string& send_if_name, const std::vector<std::string>& sniff_if_name, const std::string& client_mac, int repeat_num = 1)
    ...
    AckFinder(const std::vector<std::string>& sniff_if_name, const std::string& client_mac) 
